...
from signs.letter_c import LETTER_C
from signs.letter_d import LETTER_D
from signs.letter_e import LETTER_E
...
from signs.letter_m import LETTER_M
...
from signs.letter_s import LETTER_S
...
from signs.letter_x import LETTER_X
...
__all__ = [
    ...
    "LETTER_V", "LETTER_W", "LETTER_X", "LETTER_Y", "LETTER_Z", "YOU",
    "HELP", "PAIN", "MEDICINE", "EMERGENCY",
    "DOCTOR", "NURSE", "SICK", "FEVER", "WATER", "BREATHE", "HOSPITAL", "DIZZY",
