...
FRIEND = Sign(
    ...
    dominant=HandShapeReq(kind="index", required=True, min_confidence=0.34),
    nondominant=HandShapeReq(kind="index", required=True, min_confidence=0.59),
    ...
    movement=MovementReq(
        ...
        min_duration_s=0.5,
        required=True, min_confidence=0.35),
)
