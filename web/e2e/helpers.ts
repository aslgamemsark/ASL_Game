...
/**
 * Walks guest onboarding to Home for both configured and unconfigured Supabase environments.
 *
 * Updated for the 2026-08-30 value-before-signup reorder: skill selection now leads to a
 * 'firstSign' step (try a real sign, camera-gated) before optional auth and Home. No
