  ...
  return (
    <div className="fixed inset-0 z-[200] bg-black/70 backdrop-blur-sm flex items-end sm:items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-6 text-sm text-z-gray-300 leading-relaxed space-y-4 border-y border-z-gray-400/10 py-4">
          <section>
        ...
        <div className="px-6 pt-4 pb-6 shrink-0">
          ...
          <button
            ...
            className="w-full mt-2 py-2 text-xs font-medium text-z-gray-500 hover:text-z-gray-400 transition-colors"
          >
            Accept later
          </button>
        </div>
