...
export const ZIPPY_LINES = {
  ...
  // The very first lesson anyone ever finishes — a one-time amplified moment, not the regular
  // lessonComplete* lines. See useUserStore's firstLessonCelebrated flag.
  firstLessonComplete: [
