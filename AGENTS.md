...
- .Codex/rules/complexity.md
- .Codex/rules/modules.md
- .Codex/rules/information-hiding.md
- .Codex/rules/error-handling.md
- .Codex/rules/comments.md
- .Codex/rules/naming.md
- .Codex/rules/process.md
- .Codex/rules/red-flags.md
- .Codex/rules/no-hardcoding.md
- .Codex/rules/file-placement.md
- .Codex/rules/fixes.md

*Concurrency and timing bugs:*
- .Codex/rules/concurrency/race-conditions.md
- .Codex/rules/concurrency/toctou.md
- .Codex/rules/concurrency/deadlock.md
- .Codex/rules/concurrency/livelock.md
- .Codex/rules/concurrency/starvation.md
- .Codex/rules/concurrency/order-violations.md
- .Codex/rules/concurrency/fire-and-forget-tasks.md
- .Codex/rules/concurrency/resource-cleanup.md
- .Codex/rules/concurrency/event-ordering-assumptions.md
- .Codex/rules/concurrency/testing-concurrency-bugs.md

*Systems and OS-level bugs:*
- .Codex/rules/systems/memory-safety.md
- .Codex/rules/systems/resource-limits.md
- .Codex/rules/systems/process-signals.md
- .Codex/rules/systems/filesystem-issues.md
- .Codex/rules/systems/networking.md
- .Codex/rules/systems/numeric-issues.md
- .Codex/rules/systems/time-date-handling.md
- .Codex/rules/systems/silent-error-handling.md
- .Codex/rules/systems/internationalization-encoding.md
...
The 3D avatar work lives on branch `Codex/avatar-lab-prototype` (module `web/src/avatar/`).
